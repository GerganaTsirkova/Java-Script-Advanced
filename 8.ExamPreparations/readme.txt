...
First of all, in case that the number of given names is wrong, throw an error:  "
⦁	". Secondly, in case that a name with a wrong format is given, throw the following error: "Invalid full name".
